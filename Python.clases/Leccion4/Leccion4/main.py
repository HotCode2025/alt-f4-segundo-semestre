...
print(nombres[1])
print(nombres[3])
print(nombres[-1]) #Usamos el -1 para ver el ultimo
print(nombres[-2]) #Usamos el -2 para ver el penultimo
'''
...
for nombre in nombres: # Nombre es singular, la lista es plural
    ...
    print('Se acabaron los elementos de la lsita')

#Preguntamos cuantos elementos tiene
print(len(nombres)) # le pasamos como parametro la lsita
...
nombres.insert(1,'Alberto') #Primero agregamos el numero de la posocion y luego el nombre
print(nombres)
...
nombres.pop() #Elimina el ultimo elemento de nuestra lista
print(nombres)
...
#del cocina (Esto usamos para eliminar la tupla)

#Tipo set
planetas = {'Marte', 'Jupiter', 'Venus'}
print(planetas)
print(len(planetas)) # Usamos la funccion len = length significa largo

#Revisar si un elemento existe dentro de set
print('Marte' in planetas) #las palabras deben estar igual, si no, no la reconoce
...
#Verficar la cantidad de elementos del diccionario
...
#Otras maneras para acceder a un diccionario
for termino in diccionario.keys(): #Estamos usando una funcion
    print(termino) # Muestra solo las llaves

for valor in diccionario.values(): # Usamos una funccion para acceder al valor
    print(valor)
...
print(conjunto3.issuperset(conjunto1)) #Preguntamos si los elementos del conjunto1 esta dentro del 3
...
print(conjunto1.isdisjoint(conjunto2)) #Si hay cosas en comun
...
diccionario2 = {'Gabriel': {'Edad': 26, 'Altura': 1.65}, 'Osvaldo': [45, 1.85], 'Natalia': [35, 1.67]}
print(diccionario2)

seleccionArgentina = {
    10: {'Nombre': "Lionel", "apellido": "Messi","edad": 37, "altura": 1.70, "precio": 50000000, "posición": "Delantero"},
    23: {"nombre": "Emiliano","apellido": "Martínez","edad": 32,"altura": 1.95,"precio": 35000000,"posición": "Arquero"},
     9: {"nombre": "Julián","apellido": "Álvarez", "edad": 25, "altura": 1.75,"precio": 80000000,"posición": "Delantero"},
     7: {"nombre": "Rodrigo","apellido": "De Paul","edad": 30,"altura": 1.80,"precio": 40000000,"posición": "Mediocampista"}
}
